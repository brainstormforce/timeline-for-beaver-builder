	...
	class BSFBBTimeline {
		...
		public function admin_notices_function() {
			...
			/* Translators: Timeline Module For Beaver Builder */
				echo '<p>' . sprintf( __( 'The <strong>Timeline Module For Beaver Builder</strong> plugin requires <strong><a href="%s">Beaver Builder</strong></a> plugin installed & activated.', 'bb-timeline' ) . '</p>', $url );   //phpcs:ignore
